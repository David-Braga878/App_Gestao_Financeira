...
const PayablesForm = ({ onAddPayable, companies }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        title: "Sucesso",
        description: "Valor a pagar registrado com sucesso!"
      });

    } catch (error) {
      console.error('Erro ao registrar valor a pagar:', error);
      toast({
        title: "Erro",
        description: "Erro ao registrar valor a pagar. Tente novamente.",
        variant: "destructive"
      });
    }
  };
